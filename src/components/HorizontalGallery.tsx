      ...
      <div className="gallery-item-inner relative w-full h-full overflow-hidden bg-bg-secondary group">
        ...
        {isFirst && (
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent flex flex-col justify-end p-8 md:p-16">
            <h1 className="text-white font-syne font-extrabold text-6xl md:text-[min(12vw,140px)] uppercase leading-[0.8] tracking-tighter mb-4 drop-shadow-2xl">
              Daline Ribeiro
            </h1>
            <p className="text-white/90 font-syne font-normal text-base md:text-xl tracking-[0.3em] uppercase opacity-0 animate-fade-in-up" style={{ animationDelay: '400ms', animationFillMode: 'forwards' }}>
