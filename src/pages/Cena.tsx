...
function WorkCard({ work, index, onClick }: { work: Work; index: number; onClick: () => void }) {
  return (
    ...
    >
      ...
      <h3 className="font-display italic text-xl md:text-2xl text-ink-primary leading-tight">
        {work.title}
      </h3>
      {work.period && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-8 md:p-16">
          <div className="space-y-8">
            <div>
              ...
              <h2 className="font-display italic text-4xl md:text-5xl text-ink-primary leading-tight">
                {work.title}
              </h2>
            </div>
